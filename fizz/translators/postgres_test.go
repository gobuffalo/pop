...
var trans = translators.Postgres{}
...
func Test_Postgres_DropTable(t *testing.T) {
	...
	res, _ := fizz.AString(`drop_table("users")`, trans)
	r.Equal(ddl, res)
}
...
func Test_Postgres_RenameTable(t *testing.T) {
	...
	res, _ := fizz.AString(`rename_table("users", "people")`, trans)
	r.Equal(ddl, res)
}
...
func Test_Postgres_RenameTable_NotEnoughValues(t *testing.T) {
	...
	_, err := trans.RenameTable([]fizz.Table{})
	r.Error(err)
}
...
func Test_Postgres_AddColumn(t *testing.T) {
	...
	res, _ := fizz.AString(`add_column("mytable", "mycolumn", "string", {"default": "foo", "size": 50})`, trans)
...
func Test_Postgres_DropColumn(t *testing.T) {
	...
	res, _ := fizz.AString(`drop_column("table_name", "column_name")`, trans)
...
func Test_Postgres_RenameColumn(t *testing.T) {
	...
	res, _ := fizz.AString(`rename_column("table_name", "old_column", "new_column")`, trans)
	r.Equal(ddl, res)
}
...
func Test_Postgres_AddIndex(t *testing.T) {
	...
	res, _ := fizz.AString(`add_index("table_name", "column_name", {})`, trans)
	r.Equal(ddl, res)
}
...
func Test_Postgres_AddIndex_Unique(t *testing.T) {
	...
	res, _ := fizz.AString(`add_index("table_name", "column_name", {"unique": true})`, trans)
	r.Equal(ddl, res)
}
...
func Test_Postgres_AddIndex_MultiColumn(t *testing.T) {
	...
	res, _ := fizz.AString(`add_index("table_name", ["col1", "col2", "col3"], {})`, trans)
	r.Equal(ddl, res)
}
...
func Test_Postgres_AddIndex_CustomName(t *testing.T) {
	...
	res, _ := fizz.AString(`add_index("table_name", "column_name", {"name": "custom_name"})`, trans)
	r.Equal(ddl, res)
}
...
func Test_Postgres_DropIndex(t *testing.T) {
	...
	res, _ := fizz.AString(`drop_index("my_idx")`, trans)
	r.Equal(ddl, res)
}
...
func Test_Postgres_RenameIndex(t *testing.T) {
	...
	res, _ := fizz.AString(`rename_index("old_ix", "new_ix")`, trans)
	r.Equal(ddl, res)
}
